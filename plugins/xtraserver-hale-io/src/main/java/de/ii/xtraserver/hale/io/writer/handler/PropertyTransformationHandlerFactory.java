...
public class PropertyTransformationHandlerFactory
  ...
  private static final String SQL_EXPRESSION_ID =
      "eu.esdihumboldt.hale.io.xtraserver.sqlExpression";

  private static final String[] supportedTypes = {
    RenameFunction.ID,
    MathematicalExpressionFunction.ID,
    AssignFunction.ID,
    AssignFunction.ID_BOUND,
    FormattedStringFunction.ID,
    RegexAnalysisFunction.ID,
    ClassificationMappingFunction.ID,
    CustomFunctionAdvToGeographicalNameSimple.FUNCTION_ID,
    CustomFunctionAdvToIdentifier.FUNCTION_ID,
    CustomFunctionAdvToLocalId.FUNCTION_ID,
    CustomFunctionAdvToNamespace.FUNCTION_ID,
    CustomFunctionAdvToUCUM.FUNCTION_ID,
    CustomFunctionAdvLnToIdentifier.FUNCTION_ID,
    CustomFunctionAdvLnToName.FUNCTION_ID,
    SQL_EXPRESSION_ID
  };
  static final Set<String> SUPPORTED_TYPES =
      Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(supportedTypes)));

  @SuppressWarnings("serial")
  PropertyTransformationHandlerFactory(final MappingContext mappingContext) {
    super(
        mappingContext.getReporter(),
        new HashMap<String, PropertyTransformationHandler>() {

          {
            ...
            put(supportedTypes[i++], new CustomFunctionAdvToGeographicalNameSimple(mappingContext));
            ...
            put(supportedTypes[i++], new CustomFunctionAdvLnToIdentifier(mappingContext));
            put(supportedTypes[i++], new CustomFunctionAdvLnToName(mappingContext));
