...
abstract class AbstractPropertyTransformationHandler implements PropertyTransformationHandler {
	...
	/**
	 * Check if the property cell is a reference and if yes return the association
	...
	@Override
	public final FeatureSchema.Builder handle(final Cell propertyCell) {
		final Property targetProperty = XtraServerMappingUtils.getTargetProperty(propertyCell);
		...
		final Optional<FeatureSchema.Builder> optionalMappingValue = doHandle(propertyCell, targetProperty);
	...
	protected abstract Optional<FeatureSchema.Builder> doHandle(final Cell propertyCell,
