...
public final class MappingContext {
    ...
    private ImmutableFeatureSchema.Builder currentFeatureTypeMapping;
    ...
    ImmutableFeatureSchema.Builder addNextFeatureSchema(final QName featureTypeName) {
        ...
        if (currentFeatureTypeMapping == null) {
            currentFeatureTypeMapping =
                    new ImmutableFeatureSchema.Builder().name(featureTypeName.getLocalPart().toLowerCase(Locale.ENGLISH)).type(Type.OBJECT);
